<div class="container product-container">
    ...
    @if($productBtnBuy)<div class="row"> <div class="col-12"> <button class="form-control btn btn-danger btn-sm" wire:click="$emit('buy', {{$product->id}})">BUY</button></div></div>@endif
    ...
    @if($productBtnSell)<div class="row"> <div class="col-12"> <button class="form-control btn btn-success btn-sm" wire:click="sell({{$product->id}}, 2)">SELL</button></div></div>@endif
    ...
    @if($productBtnDelete)<div class="row"> <div class="col-12"> <button class="form-control btn btn-danger btn-sm" wire:click="delete({{$product->id}})">DELETE</button></div></div>@endif
</div>